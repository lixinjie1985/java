...
public class FastJson {
	...
	public static void mapJson() {
		...
		System.out.println(jsonObj.getIntValue("age"));
		System.out.println(jsonObj.getBooleanValue("married"));
		//获取json对象中的json对象
		JSONObject scoresObj = jsonObj.getJSONObject("scores");
		System.out.println(scoresObj.getIntValue("chinese"));
		System.out.println(scoresObj.getIntValue("math"));
		//获取json对象中的json数组
